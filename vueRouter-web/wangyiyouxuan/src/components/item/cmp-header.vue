<template>
      <div class="detail-header clearfix">
          <div class=" fl" :class="{'zoomview-open':zoom.open,'zoomview':!zoom.open}">
              <!-- 大图 -->
            <div class="zoomview-big"  
            @mouseover="zoom.open=true"
            ...
            <ul class="zoomview-thumbs clearfix">
              <li class="fl" v-for='(item,index) in data.thumb' :key='index' :class="{cur:zoom.active==index}" @click="zoom.active=index">
                <img :src="item" alt="">
              </li>
            </ul>
            <!-- 原图 -->
            <div class="zoomview-org">
              <img :src="data.org[zoom.active]" alt="" :style="{left:zoom.bigX+'px',top:zoom.bigY+'px'}">
            </div>
          </div>
