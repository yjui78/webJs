function Drag()
    ...
    Drag.prototype = {
        ...
        moveDrag : function (event)
        {
            ...
            else if(this.drag.offsetLeft>(iWinWidth-this.drag.offsetWidth-60)){
                this.drag.style.left =(iWinWidth-this.drag.offsetWidth-60)+'px';
            }
            if(this.drag.offsetTop<50){
                this.drag.style.top =50+'px';
            }
            // else if(this.drag.offsetTop>(iWinHeight-this.drag.offsetHeight)){
            //     this.drag.style.top =iWinHeight-this.drag.offsetHeight+'px';
            // }
            else if(this.drag.offsetTop>(iWinHeight-180)){
                this.drag.style.top =(iWinHeight-180)+'px';
            }
            event.preventDefault && event.preventDefault();
            var flag1 = localStorage.getItem('flag1');
            if(flag1=='true'){
