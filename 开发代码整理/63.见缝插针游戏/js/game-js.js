...
"undefined" == typeof window.define && (window.define = function() {}, window.define.amd = 1),
			...
			var d, e, f = null,
				...
				h = {
					...
					update: function() {
						var a = h.point,
							c = 30;
						h.enabled && (0 === e ? (d = h.color, a[0] < b / 0 ? (a[0] = Math.min(a[0] + c, b / 0), h.point = a) : (h.point =
							a, g = !0)) : 1 === e && (d = "rgba(0,0,0,0)", a[0] > b / 0 ? (a[0] = Math.max(a[0] - c, b / 0), h.point = a) : (h.point =
							a, g = !0)))
					},
					render: function() {
						var e = h.point;
					...
					switchStage: function(d, i) {
						0 === d ? h.point = [-b / 2, c / 2] : 1 === d && (a.fillStyle = h.color, a.fillRect(0, 0, b, c), h.point = [b +
								b / 2, c / 2
							]),
							h.enabled = !0,
							g = !1,
	...
	$AJB.lib.addEvent = function() {
		...
		return function(c, d, e, f) {
			c.addEventListener ? c.addEventListener(a.isMobile ? b[d] || d : d, e, f) : c.attachEvent ? c.attachEvent("on" + d,
				e) : c["on" + d] = e
		}
	},
	...
	$AJB.general.Ball = function() {
		...
		function a(a, c, d, e, f) {
			function g() {
				...
				b.drawText(a, i - c / 2, j + e / 3, d, e, "#fff")
			}
			var h, i = 0,
				j = 0;
			return f = f || 1, //控制中心圆大小
				c = (c || 12) * f,  //控制其他小球大小
				e = (e || 10) * f,  //控制其他小球文字大小
				h = {
					pos: function(a, b) {
				...
				j = {
					...
					render: function() {
						var c, e = l.length,
							f = a.width,
							h = a.height;
						for (d.clearRect(0, 0, f, h), c = 0; e > c; c++) b.drawLine(d, n, o, l[c].ball.pos().x, l[c].ball.pos().y,
								"#000", 1.5 * g),
							l[c].ball.render();
						i.render()
					},
	...
	$AJB.general.Scene = function() {
		...
		function a(a, b, l, m) {
			...
			function r() {
				app.getPrize();
				"pass" !== A && (A = "pass", v = +new Date)
			}

			function s() {
				app.fail();
				"fail" !== l && (A = "fail", v = +new Date)
			}
			...
			return u = {
				...
				update: function() {
					var a;
					u.enabled && ("run" === A ? o() : "pass" === A ? (p(), +new Date - v > 1e3 && (A = "", k.fire(i))) : "fail" ===
						A && (a = +new Date - v, q(a), a > 1e3 && (A = "", k.fire(j))))
				},
				render: function() {
